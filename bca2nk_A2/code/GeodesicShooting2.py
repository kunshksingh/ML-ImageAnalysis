...
class Solution:
    ...
    def smoothing(self, u): #Smooths image (from pset1)
        ...
        cv2.rectangle(mask16, ((x-16),(y-16)), ((x+16),(y+16)), (255,255,255), -1)[0]#Square mask for threshold=15^2
    ...
    def geodesicShooter(self): #Performs Geodesic Shooting for Diffeomorphic Image Registration
        ...
        for i in range(STEPS):
            ...
            #Perform multiplication to find dphi_dt
            dphi_x_dt = -1 * jacobian_phi_x 
            dphi_y_dt = -1 * jacobian_phi_y 
